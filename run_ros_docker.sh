...
--mount type=bind,source=/home/mxck/mxck2_ws/mxck2_base/src/vehicle_control/config/vesc_config.yaml,target=/vesc_ws/src/vesc_driver/params/vesc_config.yaml \
